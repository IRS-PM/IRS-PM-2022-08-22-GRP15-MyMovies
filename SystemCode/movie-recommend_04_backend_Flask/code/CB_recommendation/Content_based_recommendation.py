...
def CB_recommend_top_K(user_feature, item_feature_matrix, K):
    ...
    key = {'item_index': user_unrated_vector.index.values,
           'similarity': similarity}
    item_sim_df = pd.DataFrame(key)
    # print(item_sim_df.iloc[40819], item_sim_df.iloc[58107], item_sim_df.iloc[53123])
...
if __name__ == '__main__':
    movies_feature = pd.read_csv(
        '/Users/qinwenlu/Desktop/groupProject2/recommondation_server/code/ml-latest-small/movies_feature.csv',
        index_col=0)
    user_rating = pd.read_csv(
        '/Users/qinwenlu/Desktop/groupProject2/recommondation_server/code/ml-latest-small/user-rating.csv', index_col=0)
