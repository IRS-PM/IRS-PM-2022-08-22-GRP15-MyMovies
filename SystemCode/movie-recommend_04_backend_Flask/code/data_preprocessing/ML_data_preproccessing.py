...
def data_preprocess(path, movies_df, ratings_df):
    print ("Data preprocessing starts...")
    
    #创建user-item评分矩阵
    print ("Creating original rating matrix: ")
    print ("Loading data...")
    # rating_data = pd.read_csv(path + '/data/movies_ratings.csv')
    rating_data = ratings_df
    ...
    rating_matrix.to_csv(path + '/data/user-rating.csv')
    print("Original rating matrix preprocessing is done.")
    print("--------------------------------")
    ...
    print ("Movie years: ")
    print ("Loading data...")
    # movies_data = pd.read_csv('/Users/qinwenlu/Desktop/groupProject2/recommondation_server/code/ml-latest-small/movies.csv')
    ...
    movies_data.to_csv(path + '/data/movies_feature.csv')
    print("Movie infos preprocessing is done.")
    print("--------------------------------")